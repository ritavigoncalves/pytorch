...
LD_PRELOAD=libtcmalloc.so python3 -u test_eval.py --batch 512 --type cpu_mkltensor
LD_PRELOAD=libtcmalloc.so python3 -u test_eval.py --batch 1024 --type cpu_mkltensor
